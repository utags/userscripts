// ==UserScript==
// @name                 UTags Shortcuts - staging
// @name:zh-CN           UTags 快捷导航 - staging
    ...
    const urlItems = items
      ...
      .map((item) => {
        ...
        if (item.data.startsWith('https://linux.do/challenge')) {
          processedUrl = 'https://www.google.com/url?q='.concat(
